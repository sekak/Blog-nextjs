...
const ThemeToggole = () => {
  ...
  console.log(theme)
   ...
   return (
    <div className={style.container} onClick={toggole} style={theme === "light" ? {backgroundColor:"#0f172a"} : {backgroundColor:"white"}}>
      <div className={style.ball} style={theme === "light" ? {left:"1px"} : {right:"1px"}}></div>
